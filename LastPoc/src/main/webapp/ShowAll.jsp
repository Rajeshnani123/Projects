...
<body>
 ...
 <h5>here</h5> ${emp}
  ...
  <h2><input type="button" value="Click here" onclick="window.location.href='Delete.jsp'"> CLICK TO DELETE COURSE</h2> 
   ...
   <h2><input type="button" value="Click here" onclick="window.location.href='Fetch.jsp'"> CLICK TO FETCH COURSE</h2> 
   <input type="button" value="Click here" onclick="window.location.href='Logout'"> Logout
